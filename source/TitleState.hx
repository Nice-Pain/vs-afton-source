...
class TitleState extends MusicBeatState
{
	...
	var check_aftonMenu:FlxUICheckBox;
	...
	function startIntro()
	{
		...
		var title:FlxSprite = new FlxSprite(150,150).loadGraphic(Paths.image('funkinFred'));
		add(title);

		swagShader = new ColorSwap();

		gfDance = new FlxSprite(0,0);
		gfDance.frames = Paths.getSparrowAtlas('aftonTitle');
		gfDance.animation.addByPrefix('static', 'aftonTitle idle', 24);
		gfDance.animation.addByPrefix('glitch', 'aftonTitle splush', 24);
		gfDance.animation.play('static');
		...
		logoBl.frames = Paths.getSparrowAtlas('static');
		logoBl.antialiasing = ClientPrefs.globalAntialiasing;
		logoBl.animation.addByPrefix('static', 'idle', 24);
		...
		check_aftonMenu = new FlxUICheckBox(0, 0, null, null, "Afton Menu", 100);
		//check_aftonMenu.checked = _song.notes[curSection].altAnim;
		check_aftonMenu.name = 'check_aftonMenu';
		check_aftonMenu.screenCenter();
